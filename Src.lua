...
local themes = {
    index = {'PinkDark', 'GreenDark', 'OrangeDark', 'PurpleDark', 'YellowDark'},
    PinkDark = {
        ['Shadow'] = Color3.fromRGB(20, 10, 15),
        ['Background'] = Color3.fromRGB(25, 10, 20),
        ['Page'] = Color3.fromRGB(20, 10, 20),
        ['Main'] = Color3.fromRGB(200, 50, 150),
        ['Text & Icon'] = Color3.fromRGB(255, 230, 240),
        ['Function'] = {
            ['Toggle'] = {
                ['Background'] = Color3.fromRGB(30, 10, 20),
                ['True'] = {
                    ['Toggle Background'] = Color3.fromRGB(80, 20, 60),
                    ['Toggle Value'] = Color3.fromRGB(200, 50, 150),
                },
                ['False'] = {
                    ['Toggle Background'] = Color3.fromRGB(50, 20, 40),
                    ['Toggle Value'] = Color3.fromRGB(80, 20, 60),
                }
            },
            ['Label'] = {
                ['Background'] = Color3.fromRGB(30, 10, 20),
            ...
            ['Dropdown'] = {
                ['Background'] = Color3.fromRGB(30, 10, 20),
                ['Value Background'] = Color3.fromRGB(20, 10, 15),
                ['Value Stroke'] = Color3.fromRGB(255, 255, 255),
                ['Dropdown Select'] = {
                    ['Background'] = Color3.fromRGB(20, 10, 15),
                    ['Search'] = Color3.fromRGB(40, 10, 20),
                    ['Item Background'] = Color3.fromRGB(60, 20, 40),
                }
            },
            ['Slider'] = {
                ['Background'] = Color3.fromRGB(30, 10, 20),
                ['Value Background'] = Color3.fromRGB(20, 10, 15),
                ['Value Stroke'] = Color3.fromRGB(255, 255, 255),
                ['Slider Bar'] = Color3.fromRGB(80, 20, 60),
                ['Slider Bar Value'] = Color3.fromRGB(200, 50, 150),
                ['Circle Value'] = Color3.fromRGB(255, 255, 255)
            },
            ['Code'] = {
                ['Background'] = ColorSequence.new{
                    ColorSequenceKeypoint.new(0, Color3.fromRGB(30, 10, 20)),
                    ColorSequenceKeypoint.new(1, Color3.fromRGB(30, 10, 20))
                },
                ['Background Code'] = Color3.fromRGB(60, 20, 50),
                ['Background Code Value'] = Color3.fromRGB(40, 15, 30),
                ['ScrollingFrame Code'] = Color3.fromRGB(255, 100, 200)
            },
            ['Button'] = {
                ['Background'] = Color3.fromRGB(30, 10, 20),
                ['Click'] = Color3.fromRGB(255, 200, 230)
            },
            ['Textbox'] = {
                ['Background'] = Color3.fromRGB(30, 10, 20),
                ['Value Background'] = Color3.fromRGB(20, 10, 15),
    ...
    GreenDark = {
        ...
        ['Page'] = Color3.fromRGB(10, 20, 10),
        ['Main'] = Color3.fromRGB(30, 150, 80),
        ...
        ['Function'] = {
            ['Toggle'] = {
                ...
                ['False'] = {
                    ['Toggle Background'] = Color3.fromRGB(25, 40, 25),
                    ['Toggle Value'] = Color3.fromRGB(40, 60, 40),
                }
            },
            ['Label'] = {
                ['Background'] = Color3.fromRGB(20, 30, 20),
            ...
            ['Dropdown'] = {
                ['Background'] = Color3.fromRGB(20, 30, 20),
                ['Value Background'] = Color3.fromRGB(10, 20, 10),
                ['Value Stroke'] = Color3.fromRGB(255, 255, 255),
                ['Dropdown Select'] = {
                    ['Background'] = Color3.fromRGB(10, 20, 10),
                    ['Search'] = Color3.fromRGB(25, 35, 25),
            ...
            ['Slider'] = {
                ...
                ['Value Background'] = Color3.fromRGB(10, 20, 10),
                ['Value Stroke'] = Color3.fromRGB(255, 255, 255),
                ['Slider Bar'] = Color3.fromRGB(40, 80, 40),
            ...
            ['Code'] = {
                ...
                ['Background Code'] = Color3.fromRGB(35, 55, 35),
                ['Background Code Value'] = Color3.fromRGB(25, 45, 25),
                ['ScrollingFrame Code'] = Color3.fromRGB(120, 255, 150)
            },
            ['Button'] = {
                ['Background'] = Color3.fromRGB(20, 30, 20),
